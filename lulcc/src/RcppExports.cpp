...
RcppExport SEXP _lulcc_allowfun(SEXP luSEXP, SEXP histSEXP, SEXP codesSEXP, SEXP changedirSEXP, SEXP rulesSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _lulcc_autoconvert(SEXP luSEXP, SEXP maskSEXP, SEXP probSEXP, SEXP codesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type lu(luSEXP);
...
RcppExport SEXP _lulcc_inC(SEXP xSEXP, SEXP tableSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _lulcc_orderC(SEXP xSEXP, SEXP decreasingSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _lulcc_ordered(SEXP lu0SEXP, SEXP tprobSEXP, SEXP dmdSEXP, SEXP alloc_orderSEXP, SEXP categoriesSEXP, SEXP stochasticSEXP, SEXP maxiterSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _lulcc_updatehist(SEXP lu0SEXP, SEXP lu1SEXP, SEXP histSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type lu0(lu0SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_lulcc_allowfun", (DL_FUNC) &_lulcc_allowfun, 5},
    {"_lulcc_autoconvert", (DL_FUNC) &_lulcc_autoconvert, 4},
    {"_lulcc_inC", (DL_FUNC) &_lulcc_inC, 2},
    {"_lulcc_orderC", (DL_FUNC) &_lulcc_orderC, 2},
    {"_lulcc_ordered", (DL_FUNC) &_lulcc_ordered, 7},
    {"_lulcc_updatehist", (DL_FUNC) &_lulcc_updatehist, 3},
...
RcppExport void R_init_lulcc(DllInfo *dll) {
